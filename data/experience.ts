...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    summary:
      "Delivered end-to-end data-driven implementations for Fortune 500 clients across 120+ countries in production environments: owned client calls, requirements, and configuration debugging with Python and SQL. Cut client setup time by roughly 70% with standardised configuration templates and playbooks across 3 to 4 enterprise implementations. Built Power BI financial dashboards and recurring performance reporting that stakeholders used for operational decisions, with attention to data quality and delivery controls.",
    tools: [
      "Python",
      "SQL",
      "Power BI",
  ...
  },
  {
    ...
    summary:
      "Shipped 4 to 5 machine learning features to 10,000+ production users, including ML-powered image classification and an NLP customer-service bot, raising CSAT from 3.2 to 4.6. Led and mentored an 8 to 10 person engineering and design team at a startup generating about 1 crore INR (about EUR 110K); authored 3 to 4 PRDs and 2 roadmaps.",
    tools: [
      "Python",
      "TensorFlow",
      "NLP",
